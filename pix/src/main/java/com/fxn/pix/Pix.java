...
public class Pix extends AppCompatActivity implements View.OnTouchListener {
    ...
    private void initialize() {
        ...
        DrawableCompat.setTint(selection_back.getDrawable(), colorPrimaryDark);
        updateImages();
        if (options.isStartWithOutCamera()) {
            mBottomSheetBehavior.setSaveFlags(BottomSheetBehavior.SAVE_HIDEABLE);
            mBottomSheetBehavior.setHideable(false);
            mBottomSheetBehavior.setState(BottomSheetBehavior.STATE_EXPANDED);
            Utility.manipulateVisibility(Pix.this, 1, findViewById(R.id.arrow_up),
       ...
       /* mBottomSheetBehavior.setBottomSheetCallback(new BottomSheetBehavior.BottomSheetCallback() {
            ...
            public void onStateChanged(@NonNull View bottomSheet, int newState) {
                if (newState == BottomSheetBehavior.STATE_EXPANDED) {
                    if (mBottomSheetBehavior instanceof WABottomSheetBehaviour) {
                        ((WABottomSheetBehaviour) mBottomSheetBehavior).setLocked(true);
                    }
                }
            }
            ...
            public void onSlide(@NonNull View bottomSheet, float slideOffset) {
                ...
                if (slideOffset == 1) {
                    ...
                    if (options.isStartWithOutCamera()) finish();
    ...
    public void onBackPressed() {
        ...
        if (selectionList.size() > 0) {
            ...
            if (options.isStartWithOutCamera()) super.onBackPressed();
